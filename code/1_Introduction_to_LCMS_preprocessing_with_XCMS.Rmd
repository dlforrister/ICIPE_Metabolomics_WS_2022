...
bpc_raff <- chromatogram(rawData, mz = c(503.1, 503.2),rt = c(0, 100),
                           aggregationFun = "max")
...
bpc_trypt <- chromatogram(rawData, mz = c(203.0, 203.2),rt = c(100, 500),
                           aggregationFun = "max")
bpc_camphor <- chromatogram(rawData, mz = c(231.0, 231.1),rt = c(200, 400),
                           aggregationFun = "max")
bpc_epic <- chromatogram(rawData, mz = c(289.0, 289.15),rt = c(200, 500),
                           aggregationFun = "max")
bpc_rutin <- chromatogram(rawData, mz = c(609.1, 609.2),rt = c(350, 500),
                           aggregationFun = "max")
bpc_morin <- chromatogram(rawData, mz = c(301.0, 301.1),rt = c(400, 600),
                           aggregationFun = "max")
bpc_digoxin <- chromatogram(rawData, mz = c(825.35, 825.45),rt = c(550, 700),
                           aggregationFun = "max")
bpc_glyc <- chromatogram(rawData, mz = c(821.35, 821.45),rt = c(500, 750),
                           aggregationFun = "max")
...
we can adjust bw from 25 to smaller values. This will separate masses that are close in time.
...
Next we group all features accross the dataset using these newly defined paramaters.
